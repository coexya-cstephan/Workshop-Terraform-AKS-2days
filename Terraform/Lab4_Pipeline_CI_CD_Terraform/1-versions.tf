...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "Test-CSN-AKSCluster"     # mettre ici le nom du resource group de vos ressource
    storage_account_name = "testcsnterraform"  # /!\ mettre le nom du compte de stockage créer dans le lab 1
